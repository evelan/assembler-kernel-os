...
POWROT_DO_RM MACRO	
   ...
   A20_OFF
	...
	MOV AH,9		;Wydruk tekstu zapisanego w zmiennej INFO. 	          	
	MOV DX,OFFSET INFO						           	
	INT 21H									
...
START2:
  ...
  MOV EDI, 0B8000H
  ADD EDI, 80*2*11
  MOV EBX, OFFSET TEKST_PM
  CALL WYPISZ_TEKST
  MOV EDI, 0B8000H
  ADD EDI, 80*2*12
  MOV EBX, OFFSET WIELKOSC_PAMIECI_TXT
  CALL WYPISZ_TEKST
...
WIELKOSC_PAMIECI_TXT	 DB 'WIELKOSC PAMIECI WYRAZONA W HEX=    ', 0
