;Podstawowy przyk≥ad prze≥πczenia zadaÒ
.386P
INCLUDE STRUKT.TXT
DANE	SEGMENT USE16
;Globalna tablica deskryptorÛw
GDT_0		LABEL WORD
INCLUDE GDT.TXT
...
ORG_IDT		DQ	0
REAL_SP		DW	0	;WSKAèNIK STOSU DLA TRYBU REAL
REAL_SS		DW	0	;
INCLUDE PM_DATA.TXT
...
TASK0_OFFS	DW	0
TASK0_SEL	DW	48
TASK1_OFFS	DW	0	;4-bajtowy adres dla prze≥πczenia
